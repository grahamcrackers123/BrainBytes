...
export default defineConfig([
  { ignores: ["node_modules/**", "package-lock.json", "package.json", "coverage/**", "dist/**"] },
  { files: ["**/*.js"], plugins: { js }, extends: ["js/recommended"], languageOptions: { sourceType: "commonjs", globals: { ...globals.node, ...globals.jest } } },
